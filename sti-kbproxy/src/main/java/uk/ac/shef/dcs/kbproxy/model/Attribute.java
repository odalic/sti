...
/**
 * An attribute of a resource forms a triple with that resource. It must contain a relation, and a
 * value which is the object of the triple. The resource is always the subject
 */
public abstract class Attribute implements Serializable {

  private static final long serialVersionUID = 3373608873316502832L;
  ...
  protected boolean isDirect = true; // if this attribute is a direct attribute. this is generally
                                     // 'true'. for freebase,
   ...
   */
  public abstract boolean isAlias(ProxyDefinition definition);

  /**
   *
   * @return true if the attribute is about description
   */
  public abstract boolean isDescription(ProxyDefinition definition);
  ...
  public boolean equals(Object o) {
    if (o instanceof Attribute) {
      ...
      return a.getRelationURI().equals(this.getRelationURI())
          && a.getValue().equals(this.getValue());
    }
    return false;
  }
