...
public class DBpediaProxy extends SPARQLProxy {
  ...
  @SuppressWarnings("unused") // TODO: Verify whether this class is used via reflection.
   ...
   * @throws IOException
   */
  public DBpediaProxy(KBDefinition kbDefinition, Boolean fuzzyKeywords, String cachesBasePath,
