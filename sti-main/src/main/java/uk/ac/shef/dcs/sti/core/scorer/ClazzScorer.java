...
/**
 * Created with IntelliJ IDEA. User: zqz Date: 24/01/14 Time: 13:47 To change this template use File
...
public interface ClazzScorer {
   ...
   * @return
   */
  List<TColumnHeaderAnnotation> computeCCScore(Collection<TColumnHeaderAnnotation> candidates,
  ...
  List<TColumnHeaderAnnotation> computeCEScore(List<Pair<Entity, Map<String, Double>>> entities,
      Collection<TColumnHeaderAnnotation> existingHeaderAnnotations, Table table, int row,
