...
public class STIConstantProperty {
  ...
  public static final boolean BOW_DISCARD_SINGLE_CHAR = true; // whether discard single char words
                                                              // from BoW
  ...
  public static final double[] SCORER_ENTITY_CONTEXT_WEIGHT = new double[] {1.0, 0.5, 1.0, 0.5}; // row,column,
                                                                                                 // column
                                                                                                 // header,
                                                                                                 // tablecontext
                                                                                                 // all
  public static final double[] SCORER_CLAZZ_CONTEXT_WEIGHT = new double[] {1.0, 1.0, 1.0, 1.0}; // all
                                                                                                // 1.0
  // header,column,out trivial, out important
  public static final double[] SCORER_RELATION_CONTEXT_WEIGHT = new double[] {1.0, 0.0, 1.0, 1.0}; // header
                                                                                                   // text,
                                                                                                   // column,
                                                                                                   // out-trivial,
                                                                                                   // out-important
  public static final double ATTRIBUTE_MATCHER_MIN_SCORE = 0.5; // for TMP, 0.01; for SMP, 0.5; for
                                                                // JI 0.8
