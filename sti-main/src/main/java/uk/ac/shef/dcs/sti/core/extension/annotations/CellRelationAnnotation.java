...
/**
 * Annotates relation between two cells on the same row in a table.
 *
...
public final class CellRelationAnnotation {
  ...
  public boolean equals(final Object obj) {
    ...
    final CellRelationAnnotation other = (CellRelationAnnotation) obj;
  ...
  public String toString() {
    return "CellRelationAnnotation [candidates=" + this.candidates + ", chosen=" + this.chosen
        + "]";
  }
}
