...
public class StoppingCriteriaInstantiator {
  ...
  public static StoppingCriteria instantiate(final String stopper_class, final String[] params)
      throws ClassNotFoundException {
    if (stopper_class.equals(IInf.class.getName())) {
      return new IInf(Double.valueOf(params[0].trim()), Integer.valueOf(params[1].trim()),
    ...
    /*
     * if(stopper_class.equals(LongtailPatternConfirmation.class.getName())){ return new
     * LongtailPatternConfirmation(Double.valueOf(params[0]), Integer.valueOf(params[1])); }
     */
