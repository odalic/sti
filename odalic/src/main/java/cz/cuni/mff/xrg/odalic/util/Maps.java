...
public final class Maps {
  ...
  /**
   * Merges the added map into the modified one. If the key of the added entry is not found in the
   * map, the entry is simply added.
   *
   ...
   */
  public static <K, V> void mergeWith(final Map<K, V> modified, final Map<K, V> added,
      final BiFunction<V, V, V> mergeFunction) throws IllegalArgumentException {

    for (final Map.Entry<K, V> addedEntry : added.entrySet()) {
